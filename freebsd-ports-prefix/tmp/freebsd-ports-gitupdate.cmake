...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/usr/local64/bin/git" --git-dir=.git rev-parse "${ref}^0"
...
execute_process(
  COMMAND "/usr/local64/bin/git" --git-dir=.git show-ref "4b35fdbd99dd03b971c420a62bd44b48c98a224f"
  WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "4b35fdbd99dd03b971c420a62bd44b48c98a224f")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("4b35fdbd99dd03b971c420a62bd44b48c98a224f" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/4b35fdbd99dd03b971c420a62bd44b48c98a224f")
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "/usr/local64/bin/git" --git-dir=.git fetch --tags --force "origin"
    WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/usr/local64/bin/git" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/usr/local64/bin/git" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
...
execute_process(
  COMMAND "/usr/local64/bin/git" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/usr/local64/bin/git" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/usr/local64/bin/git" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/usr/local64/bin/git" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/usr/local64/bin/git" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/usr/local64/bin/git" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/home/probablytom/chromium-gh/freebsd-ports'."
    ...
    execute_process(
      COMMAND "/usr/local64/bin/git" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/usr/local64/bin/git" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
    )
    execute_process(
      COMMAND "/usr/local64/bin/git" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/usr/local64/bin/git" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
      )
      execute_process(
        COMMAND "/usr/local64/bin/git" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/probablytom/chromium-gh/freebsd-ports'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/usr/local64/bin/git" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "/home/probablytom/chromium-gh/freebsd-ports"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
